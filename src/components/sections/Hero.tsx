      ...
      <div className="container relative z-10 px-4 mx-auto flex items-center justify-between">
        <div className="text-left">
          ...
          <motion.h1
            ...
            className="max-w-4xl mb-6 text-6xl font-bold tracking-tighter md:text-8xl lg:text-9xl text-foreground"
          >
          ...
          <motion.div
            ...
            className="flex flex-col items-start justify-start gap-0 sm:flex-row"
          >
        ...
        >
          <div className="relative w-96 h-96 rounded-lg overflow-hidden border border-border/50 shadow-2xl">
            <Image
